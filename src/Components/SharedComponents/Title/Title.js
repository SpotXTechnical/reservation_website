const Title = ({ text }) => {
  return (
    <div className="tw-group tw-w-max">
      <h2 className="tw-text-lg sm:tw-text-3xl tw-font-bold tw-text-gray-800 tw-relative tw-inline-block tw-whitespace-normal tw-break-words ">
        {text}
